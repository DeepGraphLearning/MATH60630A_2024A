...
schedule:
  - date: Aug.<br>26, 30
    topics:
      ...
      - name: Mathematics [<a href="assets/slides/Week1-Intro-En.pdf">En</a>] [<a href="assets/slides/Week1--Fr.pdf">Fr</a>]
  ...
  - date: Sep.<br>9, 6
    topics:
      - name: Feedforward Neural Networks & Optimization Tricks [<a href="assets/slides/Week2-FFN&Regularization-Fr.pdf">Fr</a>]
